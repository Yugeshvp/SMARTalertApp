...
public class MainActivity extends AppCompatActivity {
                    ...
                    if(s2.equals(s3)){
                        ...
                        if(checkuname==true){
                            ...
                            if(insert==true){
                                if(lang.equals("தமிழ்"))
                                {
                                    Toast.makeText(getApplicationContext(),"பதிவானது.",Toast.LENGTH_SHORT).show();
                                }
                                else if(lang.equals("English"))
                                {
                            ...
                            else
                            {
                                if(lang.equals("தமிழ்"))
                                {
                                    Toast.makeText(getApplicationContext(),"பதிவாகவில்லை.",Toast.LENGTH_SHORT).show();
                                }
                                else if(lang.equals("English"))
                                {
                            ...
                            if(lang.equals("தமிழ்"))
                            {
                                Toast.makeText(getApplicationContext(),"வேறு ஒரு பெயரை தேர்வு செய், இந்த பெயர் ஏற்கனவே உள்ளது.",Toast.LENGTH_SHORT).show();
                            }
                            else if(lang.equals("English"))
                            {
                        ...
                        if(lang.equals("தமிழ்"))
                        {
                            Toast.makeText(getApplicationContext(),"கடவுச்சொல் தவறானது.",Toast.LENGTH_SHORT).show();
                        }
                        else if(lang.equals("English"))
                        {
    ...
    private void languageCheck()   //UI Language Management
    {
        if(lang.equals("தமிழ்"))
        {
            ...
            t5.setText("உறுதியான கடவுச்சொல்:");
            b1.setText("பதிவு செய்");
            b2.setText("ஏற்கனவே உள்ளது");
            e1.setHint("பெயரை எழுது");
            e2.setHint("கடவுச்சொல்லை எழுது");
            e3.setHint("உறுதியான கடவுச்சொல்லை எழுது");
        }
        else if(lang.equals("English"))
        {
